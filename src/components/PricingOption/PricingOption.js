    ...
    return (
        <div className='bg-white p-4 rounded-lg'>
            ...
            <p>
                ...
                <span className='text-xl font-mono text-gray-500'>/mo</span>
            </p>
            <div>
            ...
            <button className='bg-green-500 font-bold flex justify-center w-full py-2 rounded mt-6 text-white hover:text-green-300'>
